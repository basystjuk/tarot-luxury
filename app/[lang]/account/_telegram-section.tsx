...
const T = {
  uk: {
    ...
    prefs_horoscope_hint: "Ранковий ping лише у дні підвищеного тиску — коли варто бути обережнішою. Спокійні дні не турбуємо.",
  ...
  ru: {
    ...
    prefs_horoscope: "Гороскоп дня",
    prefs_horoscope_hint: "Утренний ping только в дни повышенного давления — когда стоит быть осторожнее. В спокойные дни не беспокоим.",
  ...
  en: {
    ...
    prefs_horoscope_hint: "A morning ping only on high-pressure days — when it's worth taking care. Calm days stay quiet.",
