...
export default function DailyCardPage() {
  ...
  const arcana = isRu ? MAJOR_ARCANA_RU : MAJOR_ARCANA_UK;
  ...
  const months = isRu ? RU_MONTHS : UA_MONTHS;
    ...
    <>
      <section className="pt-36 pb-16 bg-[#FDFBF7] relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          <AnimatedSection>
            <span className="tag mb-6 inline-block">{isRu ? "Таро" : "Таро"}</span>
            <h1
              className="text-[clamp(2.5rem,5vw,4.5rem)] text-[#1C1512] mb-4 leading-[1.06]"
              style={{ fontFamily: "var(--font-cormorant)", fontWeight: 400 }}
            >
              {isRu ? "Карта дня" : "Карта дня"}
            </h1>
