          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative flex justify-center">
                ...
                <div className="absolute top-8 -left-4 card-luxury !p-5 !rounded-2xl text-center">
                  ...
                  <p className="text-xs text-[#7A6A58] tracking-wide">
                    {isRu ? "консультаций" : "консультацій"}
                  </p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection direction="left" delay={0.15}>
              ...
              <p className="text-[#7A6A58] leading-relaxed mb-5">
                {isRu
                  ? "Мой путь к таро начался не с мистики, а с потребности разобраться в собственных отношениях. В самый сложный момент своей жизни я нашла в картах то, чего не дали никакие книги — возможность увидеть ситуацию без осуждения и страха."
              ...
              <p className="text-[#7A6A58] leading-relaxed mb-8">
                {isRu
                  ? "Сегодня я сочетаю традиционную символику таро с доказательными подходами психологии: КПТ, нарративная практика, системная семейная терапия. Это позволяет не просто «читать карты», а по-настоящему помогать людям понимать себя и свои отношения глубже."
              ...
              >
                {isRu
                  ? '"Карты — это зеркало, которое не лжёт."'
                  : '"Карти — це дзеркало, яке не бреше."'}
              </blockquote>
              <Link href="/contacts" className="btn-primary">
                {isRu ? "Записаться на сессию" : "Записатись на сесію"}
                <ArrowRight size={16} />
              </Link>
            </AnimatedSection>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <AnimatedSection className="text-center mb-14">
            <span className="tag mb-4 inline-block">
              {isRu ? "Моя философия" : "Моя філософія"}
            </span>
            <h2
              className="text-[clamp(2rem,4vw,3.5rem)] text-[#1C1512]"
              style={{ fontFamily: "var(--font-cormorant)" }}
            >
              {isRu ? "Ценности моей практики" : "Цінності моєї практики"}
            </h2>
          </AnimatedSection>
