...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${BASE_URL}/tools/natal-chart`, priority: 0.75, changeFrequency: "monthly" as const },
    { url: `${BASE_URL}/tools/moon-phase`,  priority: 0.75, changeFrequency: "monthly" as const },
    { url: `${BASE_URL}/tools/compatibility`,priority:0.7,  changeFrequency: "monthly" as const },
    { url: `${BASE_URL}/tools/daily-card`,  priority: 0.7,  changeFrequency: "daily"   as const },
    { url: `${BASE_URL}/tools/numerology`,  priority: 0.7,  changeFrequency: "monthly" as const },
