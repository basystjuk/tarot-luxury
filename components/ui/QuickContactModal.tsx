    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm bg-[#FDFBF7] rounded-3xl shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between px-7 pt-7 pb-4">
          ...
          <button onClick={closeQuickContact} className="p-2 text-[#7A6A58] hover:text-[#1C1512] transition-colors rounded-full hover:bg-[rgba(196,169,122,0.1)]">
            <X size={20} />
          </button>
        </div>
        <div className="px-7 pb-7 space-y-3">
          <a href={contacts.telegram_url} target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-4 p-4 rounded-xl border border-[rgba(196,169,122,0.3)] hover:border-[#D4A853] transition-all duration-300 group">
          ...
          <a href={contacts.whatsapp_url} target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-4 p-4 rounded-xl border border-[rgba(196,169,122,0.3)] hover:border-[#D4A853] transition-all duration-300 group">
            <div className="w-10 h-10 rounded-xl bg-[rgba(196,169,122,0.1)] flex items-center justify-center text-[#B8883A]"><WhatsAppIcon /></div>
            <div><p className="font-medium text-[#1C1512] text-sm">WhatsApp</p></div>
          </a>
