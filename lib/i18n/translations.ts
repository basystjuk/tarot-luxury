...
export const translations = {
  uk: {
    ...
    'footer.service1': 'Один питання',
    'footer.service2': 'Розклад на відносини',
    'footer.service3': 'Прогноз на місяць',
    'footer.service4': 'Онлайн таро сесія',
    'footer.tool1': 'Натальна карта',
    'footer.tool2': 'Місячний провідник',
    'footer.tool3': 'Сумісність знаків',
    'footer.tool4': 'Карта дня',
    'footer.tool5': 'Нумерологія',
    ...
    'meta.faq.title': 'Підказки — Питання та відповіді Таро',
  ...
  ru: {
    ...
    'footer.service1': 'Один вопрос',
    'footer.service2': 'Расклад на отношения',
    'footer.service3': 'Прогноз на месяц',
    'footer.service4': 'Онлайн таро сессия',
    'footer.tool1': 'Натальная карта',
    'footer.tool2': 'Лунный проводник',
    'footer.tool3': 'Совместимость знаков',
    'footer.tool4': 'Карта дня',
    'footer.tool5': 'Нумерология',
