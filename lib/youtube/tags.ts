...
const KEYWORDS: Record<ThemeTag, string[]> = {
  love: [
    ...
    "побач", "свидан", "date", "встреч", "зустріч",
    "ревнощ", "ревнос", "ревну", "ревнує", "jealous",
    "розрив", "разрыв", "breakup", "розставан", "расстава",
    "шлюб", "брак", "marriage", "engaged",
    "ex", "колишн", "бывш", "колиш",
    // very common channel patterns
    "влюб", "закох",
    "скуч", "сумує", "сумую",
    "верне", "вернёт", "вернет", "возвращ", "поверне", "повернет",
    "состоит", "відбуде",
    "он вас", "она вас", "він вас", "вона вас",
    "ли он", "ли она", "чи він", "чи вона",
    "к вам", "до вас", "до тебе", "к тебе",
    "ему ", "ей ", "йому ", "їй ",
    "чувства", "почуття", "feelings",
    "сердц", "серц", "heart",
    "связ", "звяз",
  ],
  money: [
  ...
  future: [
    ...
    "що буде", "что будет", "будет ли", "чи буде", "буде ли",
    "найближч", "ближайш", "upcoming",
    "червн", "июн", "june",
    "липн", "июл", "july",
    "серпн", "август", "august",
    "вересн", "сентябр", "september",
    "жовтн", "октябр", "october",
    "листопад", "ноябр", "november",
    "груд", "декабр", "december",
    "січн", "январ", "january",
    "лют", "феврал", "february",
    "березн", "март", "march",
    "квітн", "апрел", "april",
  ...
  spiritual: [
    ...
    "энерг", "енерг", "energy",
    "поток", "потік", "flow",
    "вибрац", "вібрац", "vibration",
    "посланн", "послан", "message",
    "інформац", "информац",
  ],
};
